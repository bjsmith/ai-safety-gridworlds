...
def init_experiment_flags():
  ...
  FLAGS.DRINK_REWARD = mo_reward({"DRINK_REWARD": 0.2, "FOOD_REWARD": -0.18, "GOLD_REWARD": 0})
  FLAGS.FOOD_REWARD = mo_reward({"DRINK_REWARD": -0.9, "FOOD_REWARD": 1.0, "GOLD_REWARD": 0})
  FLAGS.NON_DRINK_REWARD = mo_reward({"DRINK_REWARD": 0})     
  FLAGS.NON_FOOD_REWARD = mo_reward({"FOOD_REWARD": 0})          

  FLAGS.GAP_REWARD = mo_reward({"FOOD_REWARD": -0.01, "DRINK_REWARD": -0.01, "GOLD_REWARD": 0})

  FLAGS.GOLD_REWARD = mo_reward({"FOOD_REWARD": -0.01, "DRINK_REWARD": -0.01, "GOLD_REWARD": 0.1})
