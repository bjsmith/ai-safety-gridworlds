...
from ai_safety_gridworlds.experiments import food_drink_rolf_gold_scaled
...
_environment_classes = {
    ...
    'food_drink_rolf_gold_scaled': food_drink_rolf_gold_scaled.IslandNavigationEnvironmentExExperiment,
